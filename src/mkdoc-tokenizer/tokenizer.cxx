...
#define E(s, a) { tokenizer_state::s, tokenizer_action::a }
   ...
   /*mns */ {E(bksl,sps),E(cln ,o_a),E(num ,acc),E(num ,acc),E(bol ,out),E(fwsl,o_a),E(mns ,err),E(id  ,o_a),E(id  ,o_a),E(mns2,acc),E(pls ,o_a),E(mns ,err),E(punc,o_a),E(sl  ,o_a),E(cl  ,o_a),E(punc,o_a),E(whsp,o_a)},
   /*mns2*/ {E(bksl,sps),E(cln ,o_a),E(num ,o_a),E(num ,o_a),E(bol ,out),E(fwsl,o_a),E(mns2,err),E(id  ,o_a),E(id  ,o_a),E(mns ,o_a),E(pls ,o_a),E(mns2,err),E(punc,o_a),E(sl  ,o_a),E(cl  ,o_a),E(punc,o_a),E(whsp,o_a)},
   ...
   /*pls */ {E(bksl,sps),E(cln ,o_a),E(num ,acc),E(num ,acc),E(bol ,out),E(fwsl,o_a),E(pls ,err),E(id  ,o_a),E(id  ,o_a),E(mns ,o_a),E(pls2,acc),E(pls ,err),E(punc,o_a),E(sl  ,o_a),E(cl  ,o_a),E(punc,o_a),E(whsp,o_a)},
   /*pls2*/ {E(bksl,sps),E(cln ,o_a),E(num ,o_a),E(num ,o_a),E(bol ,out),E(fwsl,o_a),E(pls2,err),E(id  ,o_a),E(id  ,o_a),E(mns ,o_a),E(pls ,o_a),E(pls2,err),E(punc,o_a),E(sl  ,o_a),E(cl  ,o_a),E(punc,o_a),E(whsp,o_a)},
